...
function Logos() {
  return (
    <section
      id="logos"
      className="px-10 pt-10 pb-10 bg-white lg:px-20 xl:px-32"
    >
      <div className="grid grid-cols-3 items-center justify-center gap-x-8 gap-y-2 border-t border-t-gray-300 pt-10 md:grid-cols-5">
